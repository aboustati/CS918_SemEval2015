...
#Load dataset
data = []
with open("./Exercise2_data/twitter-test-A.tsv", "r") as tsvin:
...
#Create data object
obj = [ID1, ID2, processed_tweets, target_length, embedding, afinn, senti140, nrc]

#Save data object
pickleSave("processed_test_data.pickle", obj)
