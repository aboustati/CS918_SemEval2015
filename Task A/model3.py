...
if cross_validated:
    ...
    classifier.set_params(criterion = 'gini')
    ...
    pickleSave("model3_probabilities.pickle", predicted_probabilities)
    pickleSave("model3.pickle", classifier)
