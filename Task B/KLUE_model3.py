...
#Construct development feature matrices
...
if cross_validated:
    ...
    classifier.set_params(criterion = 'entropy')
    ...
    pickleSave("klue_model3_probabilities.pickle", predicted_probabilities)
    pickleSave("klue_model3.pickle", classifier)
    pickleSave("klue_vectoriser", vectoriser)
