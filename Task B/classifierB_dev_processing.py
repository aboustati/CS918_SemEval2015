...
data = []
with open("./Exercise2_data/twitter-dev-gold-B.tsv", "r") as tsvin:
...
#Covert labels from string to integers
Y = [label_dict[label] for label in labels]

#Create data object
obj = [Y, processed_tweets, tweet_length, embedding, afinn, senti140, nrc]

#Save data object
pickleSave("classifierB_processed_dev_data.pickle", obj)
